    ...
    return (
        <div className={style.container}>
            ...
            <div className={style.blocktwo}>
                <span>Copyright&copy;Mechrev0.github.io</span>
                <span style={{textAlign: 'center', color: '#999', lineHeight: '1', marginTop: '3px', marginBottom: '15px'}}>If you find any problems on this website, please contact me or create an issue in <a href="https://github.com/Mechrev0/Mechrev0.github.io/issues">here</a></span>
            </div>
        </div>
    )
}
